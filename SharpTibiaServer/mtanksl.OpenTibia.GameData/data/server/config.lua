...
GAME_PORT = 7172
INFO_PORT = 7173
CLIENT_VERSION = "8.60" -- "7.40" (experimental), "7.72" (experimental), "8.60" (stable), "8.70" (experimental), "9.86" (experimental), "10.98" (experimental)
...
server = {
	...
	login = {
		...
		accountmanager = {
			...
			playerposition = { x = 921, y = 771, z = 6 },
	...
	database = {
		-- sqlite, mysql, mssql, postgresql, oracle or memory
		type = "sqlite", 
